...
def get_direction(point1, point2):
    ...
    # calculate y axis direction y1 > y2
    ...
    # calculate x axis direction  x1 > x2
    if point1[0] > point2[0]:
        direction_str += "East"
    elif point1[0] < point2[0]:    # x1 < x2
        direction_str += "West"
    else:
        direction_str += ""
...
def draw_boxes(img, bbox, names, object_id, identities=None, offset=(0, 0)):
    ...
    for idx, (key, value) in enumerate(object_counter.items()):
        ...
        cv2.putText(img, f'Product Added', (width - 500, 35), 0, 1, [225, 255, 255], thickness=2, lineType=cv2.LINE_AA)
